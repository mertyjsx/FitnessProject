					...
					<div className="modal__inner">
						...
						<div >
							...
							<Form.Field>
								...
								<input name="title" id="title" className="m20" placeholder="Name this so you will remember" onChange={this.handleChange}></input>
							</Form.Field><Form.Field>
								<label htmlFor="details" className="ml" >Details</label>
								<input name="details" id="details" className="m20" placeholder="details" onChange={this.handleChange}></input>
							</Form.Field>
							<select id={'from'} onChange={this.handleChange} className="m20">
								<option>From</option>
